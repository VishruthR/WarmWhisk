...
curl -s -X POST -H "Content-Type: application/json"   -d '{"selector": {"activationId": "44315a56334d4d0ab15a56334d4d0aea"}}'   http://whisk_admin:some_passw0rd@127.0.0.1:5984/whisk_local_activations/_find | jq .
```
